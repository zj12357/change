...
@connect(({ LandingPageListModel, loading, login }) => ({
  LandingPageListModel,
  login,
  loading: loading.models.LandingPageListModel,
}))
class TableList extends Component {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'LandingPageListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'LandingPageListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'LandingPageListModel/remove',
          ...
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              ...
              {filtEleBtn(
                ...
                menuText,
                buttonKey.LandingAddMore,
              ) ? (
                <Button
                  type="primary"
                  icon={
                    takeIcon(this.props.login.dictionaryList, buttonKey.LandingAddMore) || 'plus'
                  }
