...
export async function getList(params) {
  return request('/api/LandingPage/LandingDomainList', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function addRule(params) {
  return request('/api/LandingPage/AddLandingDomain', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function ModifySysRole(params) {
  return request('/api/LandingPage/ModifyLandingDomain', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function removeRule(params) {
  return request('/api/LandingPage/DeleteLandingDomain', {
    method: 'POST',
    data: { ...params },
  });
}
