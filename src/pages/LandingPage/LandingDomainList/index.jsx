...
@connect(({ LandingDomainListModel, loading, login }) => ({
  LandingDomainListModel,
  login,
  loading: loading.models.LandingDomainListModel,
}))
class TableList extends Component {
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    // if (!!flag) {
    //   dispatch({
    //     type: 'LandingDomainListModel/getResourceByAdminIdServe',
    //     payload: record.id,
    //   }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'LandingDomainListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'LandingDomainListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'LandingDomainListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'LandingDomainListModel/add',
      payload: {
        ...fields,
        lpid: Number(lpid),
      },
  ...
  render() {
    ...
    return (
      <PageHeaderWrapper>
        ...
        >
          {pathname.indexOf('LandingDomainList') > -1 ? '新增落地页域名信息' : ''}
        </span>
        <Card bordered={false}>
