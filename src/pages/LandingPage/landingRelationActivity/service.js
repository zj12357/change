...
export async function getList(params) {
  return request('/api/Promotion/PromotionByDomainList', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function addRule(params) {
  return request('/api/Promotion/AddPrompotion', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function ModifySysRole(params) {
  return request('/api/Promotion/ModifyPromotion', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function removeRule(params) {
  return request('/api/Promotion/DeletePromotion', {
    method: 'POST',
    data: { ...params },
  });
}
