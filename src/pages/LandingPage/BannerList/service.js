...
export async function getList(params) {
  return request('/api/LandingPage/BannerList', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function addRule(params) {
  return request('/api/LandingPage/AddBanner', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function ModifySysRole(params) {
  return request('/api/LandingPage/ModifyBanner', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function removeRule(params) {
  return request('/api/LandingPage/DeleteBanner', {
    method: 'POST',
    data: { ...params },
  });
}
