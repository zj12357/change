...
@connect(({ BannerListModel, loading, login }) => ({
  BannerListModel,
  login,
  loading: loading.models.BannerListModel,
}))
class TableList extends Component {
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'BannerListModel/enableAccount',
      payload: {
        id,
  ...
  render() {
    ...
    return (
      <PageHeaderWrapper>
        ...
        >
          {pathname.indexOf('BannerList') > -1 ? '新增轮播图' : ''}
        </span>
        <Card bordered={false}>
