...
@connect(({ NoticeListModel, loading, login }) => ({
  NoticeListModel,
  login,
  loading: loading.models.NoticeListModel,
}))
class TableList extends Component {
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'NoticeListModel/enableAccount',
      payload: {
        id,
  ...
  render() {
    ...
    return (
      <PageHeaderWrapper>
        ...
        >
          {pathname.indexOf('NoticeLis') > -1 ? '新增落地页公告' : ''}
        </span>
        <Card bordered={false}>
