...
export async function getList(params) {
  return request('/api/LandingPage/BackgroundList', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function addRule(params) {
  return request('/api/LandingPage/AddBackground', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function ModifySysRole(params) {
  return request('/api/LandingPage/ModifyBackground', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function removeRule(params) {
  return request('/api/LandingPage/DeleteBackground', {
    method: 'POST',
    data: { ...params },
  });
}
