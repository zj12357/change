...
export async function getList(params) {
  return request('/api/LandingPage/AdvertisingList', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function addRule(params) {
  return request('/api/LandingPage/AddAdvertising', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function ModifySysRole(params) {
  return request('/api/LandingPage/ModifyAdvertising', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function removeRule(params) {
  return request('/api/LandingPage/DeleteAdvertising', {
    method: 'POST',
    data: { ...params },
  });
}
