import { addRule, getList, removeRule,ModifySysRole  , enableAccounts,ProcessCMFeedback,DetailCMFeedback} from './service';
...
const Model = {
  ...
  effects: {
    ...
    *add({ payload, callback }, { call, put }) {
      const response = yield call( ProcessCMFeedback, payload);
      if (response && response.resultData) {
