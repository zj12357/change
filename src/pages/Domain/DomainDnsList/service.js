...
export async function getList(params) {
  return request('/api/Domain/DomainDnsList', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function addRule(params) {
  return request('/api/Domain/AddDomainDns', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function ModifySysRole(params) {
  return request('/api/Domain/ModifyDomainDns', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function removeRule(params) {
  return request('/api/Domain/DeleteDomainDns', {
    method: 'POST',
    data: { ...params },
  });
}
