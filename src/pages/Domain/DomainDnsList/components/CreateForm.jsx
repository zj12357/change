...
@connect(({ DomainDnsListModel, loading }) => ({
  DomainDnsListModel,
  submitting: loading.effects['DomainDnsListModel/add'],
}))
    ...
    return (
      ...
      >
        ...
        <FormItem {...formItemLayout} label="API配置">
          {form.getFieldDecorator('apiSetting', {
            rules: [
              {
                required: false,
                message: '请输入API配置！',
            ...
            initialValue: editRoleDate.apiSetting,
          })(<Input.TextArea placeholder="请输入API配置" />)}
        </FormItem>
      </Modal>
    );
  }
