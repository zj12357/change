...
export async function getList(params) {
  return request('/api/Domain/ParameterList', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function addRule(params) {
  return request('/api/Domain/AddParameter', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function ModifySysRole(params) {
  return request('/api/Domain/ModifyParameter', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function removeRule(params) {
  return request('/api/Domain/DeleteParameter', {
    method: 'POST',
    data: { ...params },
  });
}
