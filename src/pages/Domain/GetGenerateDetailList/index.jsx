...
@connect(({ GetGenerateDetailListModel, loading, login }) => ({
  GetGenerateDetailListModel,
  login,
  loading: loading.models.GetGenerateDetailListModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    ...
    dispatch({
      type: 'GetGenerateDetailListModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...formValues,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetGenerateDetailListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetGenerateDetailListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetGenerateDetailListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetGenerateDetailListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetGenerateDetailListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
