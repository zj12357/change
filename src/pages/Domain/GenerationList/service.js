...
export async function getList(params) {
  return request('/api/Domain/GenerationList', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function addRule(params) {
  return request('/api/Domain/AddGeneration', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function ModifySysRole(params) {
  return request('/api/Domain/ModifyGeneration', {
    method: 'POST',
    data: { ...params },
  });
}
...
export async function removeRule(params) {
  return request('/api/Domain/DeleteGeneration', {
    method: 'POST',
    data: { ...params },
  });
}
