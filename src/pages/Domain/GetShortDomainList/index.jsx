...
@connect(({ GetShortDomainListModel, loading, login }) => ({
  GetShortDomainListModel,
  login,
  loading: loading.models.GetShortDomainListModel,
}))
class TableList extends Component {
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetShortDomainListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetShortDomainListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetShortDomainListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetShortDomainListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetShortDomainListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
