...
@connect(({ GetSYSBlackWordListModel, loading, login }) => ({
  GetSYSBlackWordListModel,
  login,
  loading: loading.models.GetSYSBlackWordListModel,
}))
class TableList extends Component {
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetSYSBlackWordListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetSYSBlackWordListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetSYSBlackWordListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetSYSBlackWordListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetSYSBlackWordListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
