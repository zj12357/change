...
@connect(({ GetSysTemplateConfigListModel, loading, login }) => ({
  GetSysTemplateConfigListModel,
  login,
  loading: loading.models.GetSysTemplateConfigListModel,
}))
class TableList extends Component {
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetSysTemplateConfigListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetSysTemplateConfigListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetSysTemplateConfigListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetSysTemplateConfigListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetSysTemplateConfigListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
