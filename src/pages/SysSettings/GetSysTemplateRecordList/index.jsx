...
@connect(({ GetSysTemplateRecordListModel, loading, login }) => ({
  GetSysTemplateRecordListModel,
  login,
  loading: loading.models.GetSysTemplateRecordListModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    ...
    dispatch({
      type: 'GetSysTemplateRecordListModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...formValues,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetSysTemplateRecordListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetSysTemplateRecordListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetSysTemplateRecordListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetSysTemplateRecordListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetSysTemplateRecordListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
