...
@connect(({ GetSysTemplateTypeListModel, loading, login }) => ({
  GetSysTemplateTypeListModel,
  login,
  loading: loading.models.GetSysTemplateTypeListModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    const {
      dispatch,
      GetSysTemplateTypeListModel: { data },
    } = this.props;
    ...
    dispatch({
      type: 'GetSysTemplateTypeListModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...formValues,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetSysTemplateTypeListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetSysTemplateTypeListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetSysTemplateTypeListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetSysTemplateTypeListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetSysTemplateTypeListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
