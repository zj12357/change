...
@connect(({ GetSYSBlackRecordListModel, loading, login }) => ({
  GetSYSBlackRecordListModel,
  login,
  loading: loading.models.GetSYSBlackRecordListModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    ...
    dispatch({
      type: 'GetSYSBlackRecordListModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...formValues,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetSYSBlackRecordListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetSYSBlackRecordListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetSYSBlackRecordListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetSYSBlackRecordListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetSYSBlackRecordListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
