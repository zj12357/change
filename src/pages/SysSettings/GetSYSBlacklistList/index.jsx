...
@connect(({ GetSYSBlacklistListModel, loading, login }) => ({
  GetSYSBlacklistListModel,
  login,
  loading: loading.models.GetSYSBlacklistListModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    ...
    dispatch({
      type: 'GetSYSBlacklistListModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...formValues,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetSYSBlacklistListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetSYSBlacklistListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetSYSBlacklistListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetSYSBlacklistListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetSYSBlacklistListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
