...
@connect(({ SysUserOperatedLogListModel, loading }) => ({
  SysUserOperatedLogListModel,
  submitting: loading.effects['SysUserOperatedLogListModel/add'],
}))
...
class CreateForm extends Component {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'SysUserOperatedLogListModel/DictionaryTypeLists',
      payload: {
        pageIndex: 1,
        pageSize: 300,
      },
  ...
  render() {
    const { modalVisible, form, handleAdd, handleModalVisible, editRoleDate = {}, SysUserOperatedLogListModel: { data }, submitting } = this.props;
