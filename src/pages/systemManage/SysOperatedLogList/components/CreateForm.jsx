...
@connect(({ SysOperatedLogListModel, loading }) => ({
  SysOperatedLogListModel,
  submitting: loading.effects['SysOperatedLogListModel/add'],
}))
...
class CreateForm extends Component {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'SysOperatedLogListModel/DictionaryTypeLists',
      payload: {
        pageIndex: 1,
        pageSize: 300,
      },
  ...
  render() {
    const { modalVisible, form, handleAdd, handleModalVisible, editRoleDate = {}, SysOperatedLogListModel: { data }, submitting } = this.props;
