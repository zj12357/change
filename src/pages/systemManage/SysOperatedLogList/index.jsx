...
@connect(({ SysOperatedLogListModel, loading, login }) => ({
  SysOperatedLogListModel,
  login,
  loading: loading.models.SysOperatedLogListModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    ...
    dispatch({
      type: 'SysOperatedLogListModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...params,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'SysOperatedLogListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'SysOperatedLogListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'SysOperatedLogListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'SysOperatedLogListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'SysOperatedLogListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
      ...
      <Form onSubmit={this.handleSearch} layout="inline">
        ...
        >
          ...
          {/* <Col md={11} sm={24} xl={9} xxl={6}>
            <FormItem label="开始日期">
              {getFieldDecorator('endDate')(<CustomDatePicker />)}
            </FormItem>
          </Col>

          <Col md={11} sm={24} xl={9} xxl={6}>
            <FormItem label="结束时期">
              {getFieldDecorator('startDate')(<CustomDatePicker />)}
            </FormItem>
          </Col> */}
        </Row>
      </Form>
