import { addRule, getList, removeRule,ModifySysRole ,ReSetDictionaryCache , enableAccounts,DictionaryTypeList} from './service';
import { message } from 'antd';
import { keysID, listId } from './keys.js';
const Model = {
  namespace: 'dictionaryListModel',
  state: {
    data: {
      list: [],
      pagination: {},
  ...
  effects: {
    ...
    *ResetCache({ payload, callback }, { call, put }) {
      const response = yield call( ReSetDictionaryCache);
      if (response && response.resultData) {
