...
@connect(({ systemMenuModel, loading, login }) => ({
  systemMenuModel,
  login,
  loading: loading.models.systemMenuModel,
}))
class TableList extends Component {
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'systemMenuModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'systemMenuModel/enableAccount',
      payload: {
        id,
  ...
  handleModalVisible = (flag, type, parentCode) => {
