...
@connect(({ lineUserListModel, loading }) => ({
  lineUserListModel,
  loading: loading.effects['lineUserListModel/GetUserBetsDetailHistorylist'],
}))
class Info extends Component {
  ...
  getRecordList = () => {
    ...
    dispatch({
      type: 'lineUserListModel/GetUserDetailCollectionList',
      payload: {
        userID: userId,
        beginTime,
        endTime,
  ...
  getHistorylist = (name, pagination = {}) => {
    ...
    dispatch({
      type: 'lineUserListModel/GetUserBetsDetailHistorylist',
      payload: {
        name: name,
        userID: userId,
