...
@connect(({ collectorpPurposeModel, loading }) => ({
  collectorpPurposeModel,
  submitting: loading.effects['collectorpPurposeModel/add'],
}))
  ...
  componentDidMount() {
    ...
    dispatch({
      ...
      callback: data => {
        ...
        this.setState({ sysMenuList: dictionaryList.filter(item => item.code === 'Usage') });
      },
    });
  }
  ...
  render() {
    ...
    return (
      <Modal
        ...
        width={600}
      >
        <FormItem {...formItemLayout} label="采集用途名称">
          ...
          })(<Input placeholder="请输入采集用途名称" />)}
        </FormItem>

        <FormItem {...formItemLayout} label="采集用途代码">
        ...
        <FormItem {...formItemLayout} label="采集用途备注">
