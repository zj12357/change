...
@connect(({ collectorpPurposeModel, loading, login }) => ({
  collectorpPurposeModel,
  login,
  loading: loading.models.collectorpPurposeModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    ...
    dispatch({
      type: 'collectorpPurposeModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...params,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'collectorpPurposeModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'collectorpPurposeModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'collectorpPurposeModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'collectorpPurposeModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'collectorpPurposeModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
