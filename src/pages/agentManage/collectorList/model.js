import { addRule, getList, removeRule,ModifySysRole  , enableAccounts,DictionaryTypeList,SysUserRole,SysUserRoleList} from './service';
import { message } from 'antd';
import { keysID, listId } from './keys.js';
const Model = {
  namespace: 'collectorListModel',
  state: {
    data: {
      list: [],
      pagination: {},
