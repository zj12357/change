...
@connect(({ GetLandingPageRateListModel, loading, login }) => ({
  GetLandingPageRateListModel,
  login,
  loading: loading.models.GetLandingPageRateListModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    const {
      dispatch,
      GetLandingPageRateListModel: { data },
    } = this.props;
    ...
    dispatch({
      type: 'GetLandingPageRateListModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...formValues,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetLandingPageRateListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetLandingPageRateListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetLandingPageRateListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetLandingPageRateListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetLandingPageRateListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
