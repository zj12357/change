...
@connect(({ GetBetRankModel, loading, login }) => ({
  GetBetRankModel,
  login,
  loading: loading.models.GetBetRankModel,
}))
class TableList extends Component {
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetBetRankModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetBetRankModel/enableAccount',
      payload: {
        id,
