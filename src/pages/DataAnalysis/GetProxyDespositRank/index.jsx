...
@connect(({ GetProxyDespositRankModel, loading, login }) => ({
  GetProxyDespositRankModel,
  login,
  loading: loading.models.GetProxyDespositRankModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    const {
      dispatch,
      GetProxyDespositRankModel: { data },
    } = this.props;
    ...
    dispatch({
      type: 'GetProxyDespositRankModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...formValues,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetProxyDespositRankModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetProxyDespositRankModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetProxyDespositRankModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetProxyDespositRankModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetProxyDespositRankModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
