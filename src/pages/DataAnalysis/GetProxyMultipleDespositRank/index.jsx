...
@connect(({ GetProxyMultipleDespositRankModel, loading, login }) => ({
  GetProxyMultipleDespositRankModel,
  login,
  loading: loading.models.GetProxyMultipleDespositRankModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    const {
      dispatch,
      GetProxyMultipleDespositRankModel: { data },
    } = this.props;
    ...
    dispatch({
      type: 'GetProxyMultipleDespositRankModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...formValues,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetProxyMultipleDespositRankModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetProxyMultipleDespositRankModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetProxyMultipleDespositRankModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetProxyMultipleDespositRankModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetProxyMultipleDespositRankModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
