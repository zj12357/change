...
@connect(({ GetLandingPageByIPRateListModel, loading, login }) => ({
  GetLandingPageByIPRateListModel,
  login,
  loading: loading.models.GetLandingPageByIPRateListModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    const {
      dispatch,
      GetLandingPageByIPRateListModel: { data },
    } = this.props;
    ...
    dispatch({
      type: 'GetLandingPageByIPRateListModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...formValues,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetLandingPageByIPRateListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetLandingPageByIPRateListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetLandingPageByIPRateListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetLandingPageByIPRateListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetLandingPageByIPRateListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
