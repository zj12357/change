...
@connect(({ GetProxyUserAddRankModel, loading, login }) => ({
  GetProxyUserAddRankModel,
  login,
  loading: loading.models.GetProxyUserAddRankModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    ...
    dispatch({
      type: 'GetProxyUserAddRankModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...formValues,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetProxyUserAddRankModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetProxyUserAddRankModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetProxyUserAddRankModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetProxyUserAddRankModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetProxyUserAddRankModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
