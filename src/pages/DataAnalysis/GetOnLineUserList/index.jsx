...
import { filtEleBtn, takeIcon, filterImages, toPercent } from '@/utils/utils.js';
...
@connect(({ GetOnLineUserListModel, loading, login }) => ({
  GetOnLineUserListModel,
  login,
  loading: loading.models.GetOnLineUserListModel,
}))
class TableList extends Component {
  ...
  columns = [
    ...
    {
      title: '用户在线率',
      dataIndex: 'multipleDespositRate',
  ...
  getReloadList = params => {
    ...
    dispatch({
      type: 'GetOnLineUserListModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...formValues,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetOnLineUserListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetOnLineUserListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetOnLineUserListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetOnLineUserListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetOnLineUserListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
