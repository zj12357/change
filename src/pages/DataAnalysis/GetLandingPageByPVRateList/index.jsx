...
@connect(({ GetLandingPageByPVRateListModel, loading, login }) => ({
  GetLandingPageByPVRateListModel,
  login,
  loading: loading.models.GetLandingPageByPVRateListModel,
}))
class TableList extends Component {
  ...
  getReloadList = params => {
    const {
      dispatch,
      GetLandingPageByPVRateListModel: { data },
    } = this.props;
    ...
    dispatch({
      type: 'GetLandingPageByPVRateListModel/fetch',
      payload: {
        pageIndex: current,
        pageSize: 10,
        ...formValues,
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'GetLandingPageByPVRateListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'GetLandingPageByPVRateListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'GetLandingPageByPVRateListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'GetLandingPageByPVRateListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'GetLandingPageByPVRateListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
