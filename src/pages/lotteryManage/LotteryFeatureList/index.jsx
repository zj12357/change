...
@connect(({ LotteryFeatureListModel, loading, login }) => ({
  LotteryFeatureListModel,
  login,
  loading: loading.models.LotteryFeatureListModel,
}))
class TableList extends Component {
  ...
  handleUpdateModalVisibleRole = (flag, record) => {
    ...
    if (!!flag) {
      dispatch({
        type: 'LotteryFeatureListModel/getResourceByAdminIdServe',
        payload: record.id,
      }).then(() => {
  ...
  handleUpdate = fields => {
    ...
    dispatch({
      type: 'LotteryFeatureListModel/update',
      payload: {
        role: id,
        res: fields,
      },
  ...
  enableAccount = record => {
    ...
    const { id } = record;
    dispatch({
      type: 'LotteryFeatureListModel/enableAccount',
      payload: {
        id,
  ...
  handleMenuClick = (type, record) => {
    ...
    Modal.confirm({
      ...
      onOk() {
        ...
        dispatch({
          type: 'LotteryFeatureListModel/remove',
  ...
  handleAdd = fields => {
    ...
    dispatch({
      type: 'LotteryFeatureListModel/add',
      payload: {
        ...fields,
      },
      callback: () => {
